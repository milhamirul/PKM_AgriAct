			...
			<div class="col-12 col-lg-4 col-md-4 col-sm-12">
				<div class="c-panel__widget">
					...
					<ul class="c-profile-card__social u-justify-start u-border-zero u-p-zero u-mv-small">
						...
						<li class="u-mr-xsmall"><a target="_blank" title="instagram" class="c-profile-card__social-icon u-bg-dribbble" href="https://instagram.com/agriact">
			...
			<div class="col-12 col-lg-12">
				<div class="c-panel__widget">
					<p class="u-text-center u-text-mute u-text-large u-text-bold">
						<?php echo $this->lang->line('copyright') ?> &#169; <?php echo $site['title'] . date(' 2021 -  Y') . '.All rights reserved.'; ?>
					</p>
				</div>
			</div>
