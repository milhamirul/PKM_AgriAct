            ...
            <div class="col-12">
                <div class="c-navbar u-border-bottom-zero u-p-zero">
                    ...
                    <a class="u-text-center u-mr-medium" href="<?php echo base_url() ?>" title='<?php echo $site['title'] ?>'>
                        <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 3 2'%3E%3C/svg%3E" data-src="<?php echo base_url('storage/assets/lms/default-app/img/agriact.png') ?>" alt="<?php echo $site['title'] ?>" style="width: 120px;">
                    </a>
