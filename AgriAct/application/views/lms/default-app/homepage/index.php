						...
						<div class="col-sm-12 col-lg-4">
							...
							<article class="c-event u-p-zero">
								<div class="c-event__img u-m-zero" data-mh="imaged">
									<a title="<?php echo $post['title'] ?>" class="u-color-success" href="<?php echo $post['url'] ?>">
			...
			<div class="c-card u-p-medium u-pv-xlarge" data-mh="landing-cards">
				...
				<div class="u-text-center u-justify-between">
					<div class="c-avatar c-avatar--large u-mb-small u-inline-flex">
						<img class="c-avatar__img" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 3 2'%3E%3C/svg%3E" data-src="<?php echo base_url('storage/assets/lms/default-app/img/agriact-warna.png') ?>" alt="<?php echo $this->lang->line('courses_not_found') ?>">
					</div>
